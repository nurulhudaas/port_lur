...
<body id="top">
    ...
    <header class="s-header">
        ...
        <div class="header-logo">
            <a class="site-logo" href="index.html"><img src="images/logo1.png" alt="Homepage"></a>
            <!-- <h5>hola.</h5> -->
        </div>
   ...
   <!-- home
   ================================================== -->
   <section id="home" class="s-home page-hero target-section" data-parallax="scroll" data-image-src="images/lur-bg.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <ul class="home-social">
            <li>
                <a href="https://www.facebook.com/nurulhudaasholikhah" target="_blank" ><i class="im im-facebook" aria-hidden="true"></i><span>Facebook</span></a>
            </li>
            <li>
                <a href="https://www.twitter.com/nurulhudaas" target="_blank" ><i class="im im-twitter" aria-hidden="true"></i><span>Twiiter</span></a>
            </li>
            <li>
                <a href="https://www.instagram.com/lurrr_" target="_blank" ><i class="im im-instagram" aria-hidden="true"></i><span>Instagram</span></a>
            </li>
            <li>
                <a href="https://www.linkedin.com/in/nurul-huda-almar-atush-sholikhah-5b7773117/" target="_blank" ><i class="im im-linkedin" aria-hidden="true"></i><span>LinkedIn</span></a>
            </li>
            <li>
                <a href="https://www.soundcloud.com/nrlhudaas" target="_blank" ><i class="im im-soundcloud" aria-hidden="true"></i><span>Soundcloud</span></a>
            </li>
        </ul> 
        <!-- end home-social -->
    ...
    <section id="about" class="s-about target-section">
        ...
        <div class="row narrow section-intro has-bottom-sep">
            <div class="col-full text-center">
                <h3>About</h3>
                <h1>More About Me</h1>
                <p class="lead">I am a recent associate degree graduate in Computer and Information System, Universitas Gadjah Mada. During my college period, I actively practice configure network and some programming language, done projects on android and web, and have experience of working on live projects during my internships.</p>
            </div>
        </div>
        ...
        <div class="row about-content">
            ...
            <div class="col-six tab-full left">
                ...
                <p>I have just started my career, I can’t give you any explanation that strongly encourages you to hire me, but I can promise you that if I get into this internship, I will be very loyal and dedicated to my work. I am honest and self motivated person. I am quick learner as well as team player. I can do hard work for this organization and put my effort for good progress in this organization.</p>

                <p>
                As, I am creative, reliable, and I have interest in network, design and system analyst, I can ensure you that I will always give the first priority to my responsibilities.	
                </p>
            </div>
            ...
            <div class="col-six tab-full right">
                ...
                <ul class="skill-bars">
                    ...
                    <strong>Cisco Package Tracer</strong>
                    </li>
                    <li>
        ...
        <div class="row about-content about-content--buttons">
            ...
            <div class="col-full tab-full center">
                <a href="https://drive.google.com/open?id=0B-vK-FygnnFFOFVxZEFxM2hxNElwSlZHZ3JGdTQyc1hDMzJ3" target="_blank" class="btn btn--primary full-width">Download My CV</a>
            </div>
            <!-- <div class="col-six tab-full right">
                ...
                <div class="timeline">
                    ...
                    <div class="timeline__block">
                        ...
                        <div class="timeline__header">
                            <p class="timeline__timeframe">March 2018 - Present</p>
                            <h3>Biro Pers Sekretariat Presiden</h3>
                            <h5>Network Engineer Onsite</h5>
                        </div>
                        <div class="timeline__desc">
                            <p>Understands the issues involved with administering and maintaining corporate infrastructure, including network connectivity, Internet access, VPN, etc. Helps install and improve computer software and network equipment. Participates in the implementation and support of IT-related policies.</p>
                        </div>
                    ...
                    <div class="timeline__block">
                        <div class="timeline__bullet"></div>
                        <div class="timeline__header">
                            <p class="timeline__timeframe">June 2016 - August 2016</p>
                            <h3>Qisqus Pte Ltd</h3>
                            <h5>Mobile Apps Developer Intern</h5>
                        </div>
                        <div class="timeline__desc">    
                            <p>Create test cases of Qiscus products based on Trello cards.
                                Web API testing using Postman. 
                                Build an android app named Q-Vote, that allow Qisqus staff to vote on a variety of subjects so they can make decisions easily.
                            </p>
                        </div>
                    </div> <!-- end timeline__block -->
            ...
            <div class="col-six tab-full right">
                <div class="timeline">
                    ...
                    <div class="timeline__block">
                        <div class="timeline__bullet"></div>
                        <div class="timeline__header">
                            <p class="timeline__timeframe">January 2016 - June 2016</p>
                            <h3>Vocational School, UGM</h3>
                            <h5>Assistant Lecturer</h5>
                        </div>
                        <div class="timeline__desc">
                            <p>Supervise the work of students, provide advice on study skills and help them with learning problems. Set and mark assignments and set examination questions as well as assessing the work and progress of students by reference to defined criteria and provide constructive feedback to students</p>
                        </div>
                    </div> <!-- end timeline__block -->
                    ...
                    <div class="timeline__block">
                        <div class="timeline__bullet"></div>
                        <div class="timeline__header">
                            <p class="timeline__timeframe">Mei 2013 - July 2013</p>
                            <h3>Bogor District Education Office</h3>
                            <h5>IT Support Intern</h5>
                        </div>
                        <div class="timeline__desc">
                            <p>Identify and repair the onboard computer hardware, software and network related problems. Also, upgrading of existing hardware / software as and when required</p>
                        </div>
                    </div> <!-- end timeline__block -->
            ...
            <div class="col-full">
                ...
                <div class="blog-list block-1-2 block-tab-full">
                    <article class="col-block">
                        ...
                        <div class="blog-date">
                            <a href="{{url('blog-single')}}">Sept 16, 2017</a>
                        </div>  
                        
                        <h2 class="h01"><a href="{{url('blog-single')}}">Kilas Balik Women's March Yogyakarta.</a></h2>
                        <p>
                        ...
                        <div class="blog-cat">
                                <a href="{{url('blog')}}">Event</a><a href="{{url('blog')}}">Feminism</a>
                        </div>
                    ...
                    <article class="col-block">
                        ...
                        <h2 class="h01"><a href="blog-single.html">Film Tengkorak.</a></h2>
                        <p>
                        Vestibulum ac diam sit amet quam vehicula elementum sed sit amet dui. Pellentesque in ipsum id orci porta dapibus. Donec sollicitudin molestie malesuada. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus. Cras ultricies ligula sed magna dictum porta. Sed porttitor lectus nibh..
                        </p>
    ...
    <section id="contact" class="s-contact target-section">
        ...
        <div class="row narrow section-intro">
            <div class="col-full">
                ...
                <!-- <p class="lead">I am not currently taking on new clients. However, I hope to be back accepting new projects later this year.</p> -->
                <p class="lead">Whether you would like my services for a project, get extra information on any of my work, ask me about this site or just say hello then I would love to hear from you.</p>
            </div>
        </div>
        ...
        <div class="row contact__main">
            <div class="col-eight tab-full contact__form">
                <form name="Form" id="Form" method="post" action="/contact">
                    ...
                    <div class="form-field">
                        <input name="name" type="text" id="name" placeholder="Name" value="" minlength="2" required="" aria-required="true" class="full-width">
                    </div>
                    <div class="form-field">
                        <input name="email" type="email" id="email" placeholder="Email" value="" required="" aria-required="true" class="full-width">
                    </div>
                    <div class="form-field">
                        <textarea name="message" id="message" placeholder="message" rows="10" cols="50" required="" aria-required="true" class="full-width"></textarea>
                    </div>
                    <div class="form-field">
                        <button class="full-width btn--primary" value="Send">Submit</button>
            ...
            <div class="col-four tab-full contact__infos home-content__buttons">
                ...
                <p>nrlhudaas@gmail.com<br>
                nurul.huda.a@mail.ugm.ac.id
                </p>

                <h4 class="h06">Address</h4>
                <p>
                Blok B No.10, Al-Huda street</br>
                19619 Bogor<br>
                Indonesia
                </p>
            </div>
        ...
        <div class="row">
            <div class="col-full">
                ...
                <div class="footer-logo">
                    <a class="footer-site-logo" href="#0"><img src="images/logo1.png" alt="Homepage"></a>
                </div>
